...
⚠️ **핵심 요구사항: sectionContent에는 반드시 최종 글의 실제 문장을 그대로 복사하세요!**

**프로세스:**
1. 최종 글에서 ## 또는 ### 헤딩으로 구분된 6개 본문 섹션을 찾습니다
2. 각 섹션의 **첫 2-4개 문장을 그대로 복사**하여 sectionContent에 넣습니다
3. 헤딩은 제외하고 본문 텍스트만 복사합니다
...
- **sectionContent**: ⭐ **최소 100자, 최대 300자** - 해당 섹션의 실제 원고 문장을 그대로 복사
- **summary**: 1문장 요약 (20자 내외)
...
□ sectionContent가 100자 이상인가?
□ sectionContent가 완전한 문장으로 구성되어 있는가?
□ sectionContent가 최종 글에 실제로 존재하는 텍스트인가?
□ 키워드 나열이 아니라 서술형 문장인가?
