...
- 미니멀 반추상 일러스트
- 주제 관련 장기/인체 부위를 인식 가능하게 단순화
- 깔끔한 벡터 스타일 + 자연/힐링 요소 (잎사귀, 꽃 등)
- 인물/캐릭터 없음

[구성]
- 상단 75%: 스타일화된 장기 형태 + 자연 요소
- 하단 25%: 제목 텍스트 영역 (크림색 배경)
- 폰트: 도현체(Do Hyeon) ExtraBold

[색상]
- 따뜻한 어스톤 2-3색 (#D4A373, #CCD5AE, #FAEDCD)

[배경]
- 연한 크림색/오프화이트 (#FEFAE0)

Style: Minimalist Semi-Abstract, Stylized Medical Illustration, Warm Earth Tones
`,
